...
DIRECTORY = r"F:\212\FaceMask_detector\dataset"

data = []
labels = []

#
print ("[INFO] geting images")
...
print ("[INFO] converting data and labels to NumPy arrays")

data = np.array(data, dtype="float32")
labels = np.array(labels)

#
print ("[INFO] encoding for labels")
...
H = model.fit(
    augumentation.flow(trainX, trainY, batch_size = BS),
...
#
print ("[INFO] saving mask dectector model ... ")
